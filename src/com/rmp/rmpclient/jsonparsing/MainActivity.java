	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String firstName = ((TextView) view
						.findViewById(R.id.firstName)).getText().toString();
				Log.d(SHANE_TAG, "firstName is : " + firstName);
				String lastName = ((TextView) view.findViewById(R.id.lastName))
						.getText().toString();
				String party = ((TextView) view.findViewById(R.id.party))
						.getText().toString();

				// Starting single contact activity
				Intent in = new Intent(getApplicationContext(),
						SinglePoliticianActivity.class);
	...
	private class GetContacts extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			ListAdapter adapter = new SimpleAdapter(MainActivity.this,
					politicianList, R.layout.list_item,
					new String[] { TAG_FIRST_NAME, TAG_LAST_NAME, TAG_PARTY,
							TAG_IMAGE }, new int[] { R.id.firstName,
							R.id.lastName, R.id.party });
